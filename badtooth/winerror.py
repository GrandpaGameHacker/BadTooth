...
def __WSA_ERRNO(N): return WSABASEERR + N


WSABASEERR = 10000
WSAEINTR = __WSA_ERRNO(4)
WSAEBADF = __WSA_ERRNO(9)
WSAEACCES = __WSA_ERRNO(13)
WSAEFAULT = __WSA_ERRNO(14)
WSAEINVAL = __WSA_ERRNO(22)
WSAEMFILE = __WSA_ERRNO(24)
WSAEWOULDBLOCK = __WSA_ERRNO(35)
WSAEINPROGRESS = __WSA_ERRNO(36)
WSAEALREADY = __WSA_ERRNO(37)
WSAENOTSOCK = __WSA_ERRNO(38)
WSAEDESTADDRREQ = __WSA_ERRNO(39)
WSAEMSGSIZE = __WSA_ERRNO(40)
WSAEPROTOTYPE = __WSA_ERRNO(41)
WSAENOPROTOOPT = __WSA_ERRNO(42)
WSAEPROTONOSUPPORT = __WSA_ERRNO(43)
WSAESOCKTNOSUPPORT = __WSA_ERRNO(44)
WSAEOPNOTSUPP = __WSA_ERRNO(45)
WSAEPFNOSUPPORT = __WSA_ERRNO(46)
WSAEAFNOSUPPORT = __WSA_ERRNO(47)
WSAEADDRINUSE = __WSA_ERRNO(48)
WSAEADDRNOTAVAIL = __WSA_ERRNO(49)
WSAENETDOWN = __WSA_ERRNO(50)
WSAENETUNREACH = __WSA_ERRNO(51)
WSAENETRESET = __WSA_ERRNO(52)
WSAECONNABORTED = __WSA_ERRNO(53)
WSAECONNRESET = __WSA_ERRNO(54)
WSAENOBUFS = __WSA_ERRNO(55)
WSAEISCONN = __WSA_ERRNO(56)
WSAENOTCONN = __WSA_ERRNO(57)
WSAESHUTDOWN = __WSA_ERRNO(58)
WSAETOOMANYREFS = __WSA_ERRNO(59)
WSAETIMEDOUT = __WSA_ERRNO(60)
WSAECONNREFUSED = __WSA_ERRNO(61)
WSAELOOP = __WSA_ERRNO(62)
WSAENAMETOOLONG = __WSA_ERRNO(63)
WSAEHOSTDOWN = __WSA_ERRNO(64)
WSAEHOSTUNREACH = __WSA_ERRNO(65)
WSAENOTEMPTY = __WSA_ERRNO(66)
WSAEPROCLIM = __WSA_ERRNO(67)
WSAEUSERS = __WSA_ERRNO(68)
WSAEDQUOT = __WSA_ERRNO(69)
WSAESTALE = __WSA_ERRNO(70)
WSAEREMOTE = __WSA_ERRNO(71)
WSASYSNOTREADY = __WSA_ERRNO(91)
WSAVERNOTSUPPORTED = __WSA_ERRNO(92)
WSANOTINITIALISED = __WSA_ERRNO(93)
WSAEDISCON = __WSA_ERRNO(101)
WSAENOMORE = __WSA_ERRNO(102)
WSAECANCELLED = __WSA_ERRNO(103)
WSAEINVALIDPROCTABLE = __WSA_ERRNO(104)
WSAEINVALIDPROVIDER = __WSA_ERRNO(105)
WSAEPROVIDERFAILEDINIT = __WSA_ERRNO(106)
WSASYSCALLFAILURE = __WSA_ERRNO(107)
WSASERVICE_NOT_FOUND = __WSA_ERRNO(108)
WSATYPE_NOT_FOUND = __WSA_ERRNO(109)
WSA_E_NO_MORE = __WSA_ERRNO(110)
WSA_E_CANCELLED = __WSA_ERRNO(111)
WSAEREFUSED = __WSA_ERRNO(112)
WSAHOST_NOT_FOUND = __WSA_ERRNO(1001)
WSATRY_AGAIN = __WSA_ERRNO(1002)
WSANO_RECOVERY = __WSA_ERRNO(1003)
WSANO_DATA = __WSA_ERRNO(1004)
WSA_QOS_RECEIVERS = __WSA_ERRNO(1005)
WSA_QOS_SENDERS = __WSA_ERRNO(1006)
WSA_QOS_NO_SENDERS = __WSA_ERRNO(1007)
WSA_QOS_NO_RECEIVERS = __WSA_ERRNO(1008)
WSA_QOS_REQUEST_CONFIRMED = __WSA_ERRNO(1009)
WSA_QOS_ADMISSION_FAILURE = __WSA_ERRNO(1010)
WSA_QOS_POLICY_FAILURE = __WSA_ERRNO(1011)
WSA_QOS_BAD_STYLE = __WSA_ERRNO(1012)
WSA_QOS_BAD_OBJECT = __WSA_ERRNO(1013)
WSA_QOS_TRAFFIC_CTRL_ERROR = __WSA_ERRNO(1014)
WSA_QOS_GENERIC_ERROR = __WSA_ERRNO(1015)
WSA_QOS_ESERVICETYPE = __WSA_ERRNO(1016)
WSA_QOS_EFLOWSPEC = __WSA_ERRNO(1017)
WSA_QOS_EPROVSPECBUF = __WSA_ERRNO(1018)
WSA_QOS_EFILTERSTYLE = __WSA_ERRNO(1019)
WSA_QOS_EFILTERTYPE = __WSA_ERRNO(1020)
WSA_QOS_EFILTERCOUNT = __WSA_ERRNO(1021)
WSA_QOS_EOBJLENGTH = __WSA_ERRNO(1022)
WSA_QOS_EFLOWCOUNT = __WSA_ERRNO(1023)
WSA_QOS_EUNKOWNPSOBJ = __WSA_ERRNO(1024)
WSA_QOS_EPOLICYOBJ = __WSA_ERRNO(1025)
WSA_QOS_EFLOWDESC = __WSA_ERRNO(1026)
WSA_QOS_EPSFLOWSPEC = __WSA_ERRNO(1027)
WSA_QOS_EPSFILTERSPEC = __WSA_ERRNO(1028)
WSA_QOS_ESDMODEOBJ = __WSA_ERRNO(1029)
WSA_QOS_ESHAPERATEOBJ = __WSA_ERRNO(1030)
WSA_QOS_RESERVED_PETYPE = __WSA_ERRNO(1031)
