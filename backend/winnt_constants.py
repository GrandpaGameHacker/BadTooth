...
def PRIMARYLANGID(l): return ((WORD)(l)&0x3ff)

def SORTIDFROMLCID(l): return ((WORD)((((DWORD)(l))&NLS_VALID_LOCALE_MASK)>>16))

def SORTVERSIONFROMLCID(l): return ((WORD)((((DWORD)(l))>>20)&0xf))

def SUBLANGID(l): return ((WORD)(l)>>10)

def LANGIDFROMLCID(l): return ((WORD)(l))
...
CONTEXT_ALPHA = 0x20000
CONTEXT_CONTROL = (CONTEXT_ALPHA|1)
CONTEXT_FLOATING_POINT = (CONTEXT_ALPHA|2)
CONTEXT_INTEGER = (CONTEXT_ALPHA|4)
CONTEXT_FULL = (CONTEXT_CONTROL|CONTEXT_FLOATING_POINT|CONTEXT_INTEGER)
CONTEXT_SH3 = 0x00000040
CONTEXT_SH4 = 0x000000c0
CONTEXT_CONTROL = (CONTEXT_SH3 | 0x00000001)
CONTEXT_INTEGER = (CONTEXT_SH3 | 0x00000002)
CONTEXT_DEBUG_REGISTERS = (CONTEXT_SH3 | 0x00000008)
CONTEXT_FULL = (CONTEXT_CONTROL | CONTEXT_INTEGER | CONTEXT_DEBUG_REGISTERS)
CONTEXT_CONTROL = (CONTEXT_SH4 | 0x00000001)
CONTEXT_INTEGER = (CONTEXT_SH4 | 0x00000002)
CONTEXT_DEBUG_REGISTERS = (CONTEXT_SH4 | 0x00000008)
CONTEXT_FLOATING_POINT = (CONTEXT_SH4 | 0x00000004)
CONTEXT_FULL = (CONTEXT_CONTROL | CONTEXT_INTEGER | CONTEXT_DEBUG_REGISTERS | CONTEXT_FLOATING_POINT)
CONTEXT_R4000 = 0x00010000
CONTEXT_CONTROL = (CONTEXT_R4000 | 0x00000001)
CONTEXT_FLOATING_POINT = (CONTEXT_R4000 | 0x00000002)
CONTEXT_INTEGER = (CONTEXT_R4000 | 0x00000004)
CONTEXT_FULL = (CONTEXT_CONTROL | CONTEXT_FLOATING_POINT | CONTEXT_INTEGER)
CONTEXT_ARM = 0x0000040
